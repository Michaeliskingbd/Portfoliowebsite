...
const Header = () => {
  ...
  const openNotification = () => {
    api.info({
      ...
      description: (
        <>
          Please note that this site is still under construction. Thank you!{" "}
    ...
    <header>
      ...
      <div className="container header__container">
        <h5 data-aos="flip-right" data-aos-duration="4000">
          Hello{" "}
          <span style={{ color: "#4db5ff" }}>
            {user ? user.name : "Visitor"}
          </span>
          , I'm
        </h5>
        <h1 className="fname" data-aos="flip-left">
          Michael
        </h1>
        <h1 className="lname" data-aos="flip-left">
          Aladejuyigbe
        </h1>
