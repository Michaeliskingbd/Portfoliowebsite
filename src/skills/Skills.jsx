  ...
  return (
    <div>
      <div id="skills">
        ...
        <article className="skill">
          {" "}
          <img src={Jav} alt="jav" /> Javascript
        </article>
        <article className="skill">
          {" "}
          <img src={ts} alt="ts" /> Typescript
        </article>
        <article className="skill">
          {" "}
          <img src={react} alt="jav" /> ReactJS
        </article>
        <article className="skill">
          {" "}
          <img src={native} alt="jav" /> ReactNative
        </article>
        <article className="skill">
          {" "}
          <img src={node} alt="jav" /> NodeJS
        </article>
        <article className="skill">
          {" "}
          <img style={{ width: "80px" }} src={express} alt="jav" /> ExpressJS
        </article>
        <article className="skill">
          {" "}
          <img
        ...
        <article className="skill">
          {" "}
          <img src={mongo} alt="jav" /> MongoDB
        </article>
        <article className="skill">
          {" "}
          <img src={sql} alt="jav" /> MySQL
        </article>
        <article className="skill">
          {" "}
          <img src={tailwind} alt="jav" /> TailwindCSS
        </article>
        <article className="skill">
          {" "}
          <img src={sass} alt="jav" /> SASS
        </article>
        <article className="skill">
          {" "}
          <img src={mui} alt="jav" /> Material UI
        </article>
        <article className="skill">
          {" "}
          <img src={git} alt="jav" /> Git
        </article>
        <article className="skill">
          {" "}
          <img src={jwt} alt="jav" /> JWT
        </article>
        <article className="skill">
          {" "}
          <img src={ap} alt="jav" /> Photoshop
        </article>
        <article className="skill">
          {" "}
          <img src={ai} alt="jav" />
